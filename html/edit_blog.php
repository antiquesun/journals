...
<?=$error?>
 <div id="pagetitle">Edit Blog</div>
 <br/>
 <form name="editblog" method="post" action="/edit_blog/<?=$_GET['param1']?>/">
 ...
 <div class="right">
  <ul>
   <li><input id="blogtitle" type="text" name="title" value="<?=$blog_title?>" /></li>
   <li><input id="blogtitle" type="text" name="summary" value="<?=$blog_summary?>" /></li>
   <li><textarea name="content" ><?=$blog_body?></textarea></li>
   
  </ul>
  
  <div style="padding-top: 420px;"><input type="submit" name="submit" value="Save Changes" /></div>
 </div>
